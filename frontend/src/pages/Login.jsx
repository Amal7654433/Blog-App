...
const Login = () => {
    return (
        <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center items-center">
            <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow-lg sm:rounded-lg flex w-full">
                {/* Left Side - Welcome Section */}
                <div className="hidden lg:flex flex-1 bg-indigo-500 text-white flex-col justify-center items-center p-12">
                    <h1 className="text-4xl font-extrabold">Welcome to Our Blog App</h1>
                    <p className="mt-4 text-lg text-center opacity-90">
                        Join us to explore, write, and share amazing stories.
                    </p>
                    <img
                    ...
                    <div className="mt-8 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-6">
                            ...
                            <div className="mx-auto max-w-xs">
                                ...
                                />
                                <button className="mt-5 tracking-wide font-semibold bg-indigo-600 text-white w-full py-3 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center">
